...
export const createCollectionTC = createAsyncThunk(
...
export const getCollectionsTC = createAsyncThunk(
...
export const deleteCollectionTC = createAsyncThunk(
...
export const editCollectionTC = createAsyncThunk(
  'collections/editCollection',
  async (
    params: { collection: CollectionType; oldImage?: string },
    { dispatch, getState },
  ) => {
    dispatch(setLoading(true))
    try {
      ...
      dispatch(
        setCollections(
          collections.map(coll =>
            coll._id === params.collection._id
              ? { ...coll, ...res.data.updatedCollection }
              : coll,
          ),
        ),
      )
...
export const getCollectionTC = createAsyncThunk(

...
export const ItemPage = () => {
    ...
    return (
        ...
        >
            ...
            <Descriptions.Item label="Unique Item:">{isUniqueItem
                ? <Badge status="success" text="YES"/>
                : <Badge status="error" text="NO"/>}</Descriptions.Item>
            <Descriptions.Item label="Available for sale:">{isAvailableForSale
                ? <Badge status="success" text="YES"/>
                : <Badge status="error" text="NO"/>}</Descriptions.Item>
            <Descriptions.Item label="Available for exchange:">{isAvailableForExchange
                ? <Badge status="success" text="YES"/>
                : <Badge status="error" text="NO"/>}</Descriptions.Item>
